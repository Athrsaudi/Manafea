...
const CATS = {
  ar: [{id:"aqeedah",name:"العقيدة",icon:"☪️",desc:"أصول الإيمان والتوحيد"},{id:"fiqh",name:"الفقه",icon:"📜",desc:"أحكام العبادات والمعاملات"},{id:"tafseer",name:"التفسير",icon:"📖",desc:"تفسير آيات القرآن الكريم"},{id:"seerah",name:"السيرة النبوية",icon:"✨",desc:"سيرة النبي محمد ﷺ"},{id:"hadith",name:"الحديث",icon:"📿",desc:"شرح الأحاديث النبوية الشريفة"},{id:"ethics",name:"الأخلاق",icon:"💎",desc:"الآداب والأخلاق الإسلامية"},{id:"ramadan",name:"رمضان",icon:"🌙",desc:"أحكام وفضائل شهر رمضان"},{id:"hajj",name:"الحج",icon:"🕋",desc:"مناسك الحج والعمرة"}],
  en: [{id:"aqeedah",name:"Aqeedah (Creed)",icon:"☪️",desc:"Foundations of faith and monotheism"},{id:"fiqh",name:"Fiqh (Jurisprudence)",icon:"📜",desc:"Rulings of worship and transactions"},{id:"tafseer",name:"Tafseer",icon:"📖",desc:"Interpretation of Quranic verses"},{id:"seerah",name:"Prophetic Biography",icon:"✨",desc:"The life of Prophet Muhammad ﷺ"},{id:"hadith",name:"Hadith",icon:"📿",desc:"Explanation of Prophetic traditions"},{id:"ethics",name:"Ethics & Manners",icon:"💎",desc:"Islamic etiquette and character"},{id:"ramadan",name:"Ramadan",icon:"🌙",desc:"Rulings and virtues of Ramadan"},{id:"hajj",name:"Hajj",icon:"🕋",desc:"Hajj and Umrah rituals"}],
  tr: [{id:"aqeedah",name:"Akaid",icon:"☪️",desc:"İman ve tevhid esasları"},{id:"fiqh",name:"Fıkıh",icon:"📜",desc:"İbadet ve muamelat hükümleri"},{id:"tafseer",name:"Tefsir",icon:"📖",desc:"Kur'an ayetlerinin tefsiri"},{id:"seerah",name:"Siyer",icon:"✨",desc:"Hz. Muhammed ﷺ'in hayatı"},{id:"hadith",name:"Hadis",icon:"📿",desc:"Peygamber hadislerinin şerhi"},{id:"ethics",name:"Ahlak",icon:"💎",desc:"İslami adab ve ahlak"},{id:"ramadan",name:"Ramazan",icon:"🌙",desc:"Ramazan hükümleri ve fazileti"},{id:"hajj",name:"Hac",icon:"🕋",desc:"Hac ve umre menasiki"}],
  ur: [{id:"aqeedah",name:"عقیدہ",icon:"☪️",desc:"ایمان اور توحید کے اصول"},{id:"fiqh",name:"فقہ",icon:"📜",desc:"عبادات اور معاملات کے احکام"},{id:"tafseer",name:"تفسیر",icon:"📖",desc:"قرآنی آیات کی تفسیر"},{id:"seerah",name:"سیرت نبوی",icon:"✨",desc:"نبی کریم ﷺ کی سیرت"},{id:"hadith",name:"حدیث",icon:"📿",desc:"احادیث نبویہ کی شرح"},{id:"ethics",name:"اخلاق",icon:"💎",desc:"اسلامی آداب اور اخلاق"},{id:"ramadan",name:"رمضان",icon:"🌙",desc:"رمضان کے احکام اور فضائل"},{id:"hajj",name:"حج",icon:"🕋",desc:"حج اور عمرہ کے مناسک"}],
  ms: [{id:"aqeedah",name:"Akidah",icon:"☪️",desc:"Asas iman dan tauhid"},{id:"fiqh",name:"Fiqh",icon:"📜",desc:"Hukum ibadat dan muamalat"},{id:"tafseer",name:"Tafsir",icon:"📖",desc:"Tafsir ayat-ayat Al-Quran"},{id:"seerah",name:"Sirah",icon:"✨",desc:"Kehidupan Nabi Muhammad ﷺ"},{id:"hadith",name:"Hadis",icon:"📿",desc:"Penjelasan hadis Nabi"},{id:"ethics",name:"Akhlak",icon:"💎",desc:"Adab dan akhlak Islam"},{id:"ramadan",name:"Ramadan",icon:"🌙",desc:"Hukum dan kelebihan Ramadan"},{id:"hajj",name:"Haji",icon:"🕋",desc:"Manasik Haji dan Umrah"}],
  fr: [{id:"aqeedah",name:"Aqida",icon:"☪️",desc:"Les fondements de la foi"},{id:"fiqh",name:"Fiqh",icon:"📜",desc:"Jurisprudence islamique"},{id:"tafseer",name:"Tafsir",icon:"📖",desc:"Exégèse du Coran"},{id:"seerah",name:"Sira",icon:"✨",desc:"Vie du Prophète ﷺ"},{id:"hadith",name:"Hadith",icon:"📿",desc:"Explications des traditions prophétiques"},{id:"ethics",name:"Éthique",icon:"💎",desc:"Morale et éthique islamique"},{id:"ramadan",name:"Ramadan",icon:"🌙",desc:"Règles et mérites du Ramadan"},{id:"hajj",name:"Hajj",icon:"🕋",desc:"Rituels du Hajj et de la Omra"}],
  fa: [{id:"aqeedah",name:"عقیده",icon:"☪️",desc:"اصول ایمان و توحید"},{id:"fiqh",name:"فقه",icon:"📜",desc:"احکام عبادات و معاملات"},{id:"tafseer",name:"تفسیر",icon:"📖",desc:"تفسیر آیات قرآن"},{id:"seerah",name:"سیره",icon:"✨",desc:"زندگی پیامبر ﷺ"},{id:"hadith",name:"حدیث",icon:"📿",desc:"شرح احادیث نبوی"},{id:"ethics",name:"اخلاق",icon:"💎",desc:"آداب و اخلاق اسلامی"},{id:"ramadan",name:"رمضان",icon:"🌙",desc:"احکام و فضائل رمضان"},{id:"hajj",name:"حج",icon:"🕋",desc:"مناسک حج و عمره"}],
  bn: [{id:"aqeedah",name:"আকীদা",icon:"☪️",desc:"ঈমান ও তাওহীদের ভিত্তি"},{id:"fiqh",name:"ফিকহ",icon:"📜",desc:"ইবাদত ও লেনদেনের বিধান"},{id:"tafseer",name:"তাফসীর",icon:"📖",desc:"কুরআনের আয়াতের তাফসীর"},{id:"seerah",name:"সীরাহ",icon:"✨",desc:"নবী মুহাম্মাদ ﷺ এর জীবনী"},{id:"hadith",name:"হাদীস",icon:"📿",desc:"নবী হাদীসের ব্যাখ্যা"},{id:"ethics",name:"আখলাক",icon:"💎",desc:"ইসলামিক আদব ও চরিত্র"},{id:"ramadan",name:"রমজান",icon:"🌙",desc:"রমজানের বিধান ও ফযীলত"},{id:"hajj",name:"হজ্জ",icon:"🕋",desc:"হজ্জ ও উমরাহ মানাসিক"}],
  hi: [{id:"aqeedah",name:"अक़ीदा",icon:"☪️",desc:"ईमान और तौहीद की बुनियाद"},{id:"fiqh",name:"फ़िक़्ह",icon:"📜",desc:"इबादत और लेन-देन के नियम"},{id:"tafseer",name:"तफ़सीर",icon:"📖",desc:"क़ुरान की आयतों की तफ़सीर"},{id:"seerah",name:"सीरह",icon:"✨",desc:"नबी मुहम्मद ﷺ की जीवनी"},{id:"hadith",name:"हदीस",icon:"📿",desc:"नबवी हदीस की व्याख्या"},{id:"ethics",name:"अख़्लाक़",icon:"💎",desc:"इस्लामी आदाब और चरित्र"},{id:"ramadan",name:"रमज़ान",icon:"🌙",desc:"रमज़ान के नियम और फ़ज़ीलत"},{id:"hajj",name:"हज",icon:"🕋",desc:"हज और उमरा के मनासिक"}],
};
...
const VIDS = {
  ar: {
    ...
    ethics: [{t:"حسن الخلق في الإسلام",d:"أهمية حسن الخلق ومكانته في الإسلام",f:true,ytId:"PBgWyKXFAkk"},{t:"آداب المسجد",d:"تعرف على آداب دخول المسجد والجلوس فيه",f:false,ytId:"L5HGvS3KGLY"},{t:"فضل الصدقة",d:"فضائل الصدقة وأجرها عند الله",f:false,ytId:"YMvDMH5DKRY"}],
  ...
  en: {
    ...
    ethics: [{t:"Good Character in Islam",d:"The importance and status of good character in Islam",f:true,ytId:"PBgWyKXFAkk"},{t:"Mosque Etiquette",d:"Learn about the etiquettes of entering and sitting in the mosque",f:false,ytId:"L5HGvS3KGLY"},{t:"Virtue of Charity",d:"The virtues and rewards of charity with Allah",f:false,ytId:"YMvDMH5DKRY"}],
      ...
      {activeVideo && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" style={{ background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(8px)' }} onClick={() => setActiveVideo(null)}>
          <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full overflow-hidden animate-fadeInUp" onClick={e => e.stopPropagation()} style={{ border: '1px solid rgba(200,169,81,0.2)' }}>
            {/* YouTube Player */}
            <div className="relative" style={{ background: '#000', minHeight: '240px' }}>
              <iframe
